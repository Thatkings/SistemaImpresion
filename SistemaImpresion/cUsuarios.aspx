<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="cUsuarios.aspx.cs" Inherits="SistemaImpresion.cUsuarios" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>.:: Consulta de Usuarios - Print System ::.</title>
    <style type="text/css">
        .auto-style2 {
        }
                        ...
                        <div style="height: 551px">
                            <div style="width: 652px; height: 549px; z-index: 1; left: 377px; top: 276px; position: absolute;">
                                ...
                                <div>
                                    ...
                                    <asp:GridView ID="UsuariosGridView" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" CssClass="auto-style3" Height="140px" Width="389px">
