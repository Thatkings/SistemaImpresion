<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="cInformeDiario.aspx.cs" Inherits="SistemaImpresion.cInformeDiario" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>.:: Consulta de Informe Diario - Print System ::.</title>
    <style type="text/css">
            ...
            <div>
                <div style="height: 687px">
                    <div style="width: 674px; height: 337px;">
                        ...
                        <br />
                        <br />
                        <h2 class="auto-style1">Consulta de Informe Diario</h2>
                        <br />
                        <br />
                        <br />
                        <br />
