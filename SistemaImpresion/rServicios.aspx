                    ...
                    <div>
                        ...
                        <div style="height: 627px">
                            <div style="width: 652px; height: 549px; z-index: 1; left: 377px; top: 276px; position: absolute;">
                                ...
                                <div style="height: 61px; width: 400px;">
                                    <asp:Label ID="CostoServicioLabel" runat="server" Text="Costo de Servicio" Style="font-size: medium"></asp:Label>
                                    &nbsp;&nbsp;
                                    <asp:DropDownList ID="CostoServicioDropDownList" runat="server" Width="283px">
                                    </asp:DropDownList>
                                </div>
                                ...
                                <div style="height: 61px; width: 100px; z-index: 1; left: 0px; top: 311px; position: absolute;">
                                    <asp:Button ID="GuardarButton" runat="server" Text="Guardar" />
                                </div>
                                <div style="height: 61px; width: 100px; z-index: 1; left: 100px; top: 311px; position: absolute;">
                                    <asp:Button ID="ConsultarButton" runat="server" Text="Consultar" />
                                </div>
                                <div style="height: 61px; width: 100px; z-index: 1; left: 200px; top: 311px; position: absolute;">
                                    <asp:Button ID="LimpiarButton" runat="server" Text="Limpiar" />
                                </div>
                                <div style="height: 61px; width: 100px; z-index: 1; left: 300px; top: 311px; position: absolute;">
