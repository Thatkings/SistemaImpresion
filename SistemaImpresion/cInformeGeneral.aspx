<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="cInformeGeneral.aspx.cs" Inherits="SistemaImpresion.cInformeGeneral" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>.:: Consulta de Informe General - Print System ::.</title>
    <style type="text/css">
            ...
            <div>
                <div style="height: 687px">
                    <div style="width: 674px; height: 337px;">
                        ...
                        <br />
                        <br />
                        <h2 class="auto-style1">Consulta de Informe General</h2>
                        <br />
                        <br />
                        <br />
                        <br />
                            ...
                            <div style="width: 652px; height: 549px; z-index: 1; left: 377px; top: 276px; position: absolute;">
                                ...
                                <div style="height: 74px; width: 695px">
                                    ...
                                    <div>
                                        ...
                                        <asp:GridView ID="InformeDiarioGridView" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" CssClass="auto-style3" Height="140px" Width="389px">
